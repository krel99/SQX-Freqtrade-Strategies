...
class BBTimeWindowReversion(IStrategy):
    INTERFACE_VERSION = 3
    ...
    long_revert = DecimalParameter(0.980, 1.005, default=0.999, decimals=3, space="buy")
    short_revert = DecimalParameter(0.995, 1.020, default=1.001, decimals=3, space="buy")
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[
            time_ok & width_ok & (dataframe["close"] < lower * self.long_revert.value), "enter_long"
        ] = 1

        dataframe.loc[
            time_ok & width_ok & (dataframe["close"] > upper * self.short_revert.value),
            "enter_short",
        ] = 1
