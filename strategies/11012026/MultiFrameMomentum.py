...
class MultiFrameMomentum(IStrategy):
    """
    ...
    # -- 1h Timeframe --
    buy_rsi_1h_period = IntParameter(10, 50, default=20, space="buy")
    buy_rsi_1h_threshold = IntParameter(40, 70, default=50, space="buy")
    buy_macd_1h_fast = IntParameter(6, 24, default=12, space="buy")
    buy_macd_1h_slow = IntParameter(13, 52, default=26, space="buy")
    buy_macd_1h_signal = IntParameter(5, 18, default=9, space="buy")
    ...
    buy_volume_ma_15m_period = IntParameter(10, 50, default=20, space="buy")
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        informative["rsi"] = ta.RSI(informative, timeperiod=self.buy_rsi_1h_period.value)
        macd_1h = ta.MACD(
            informative,
            fastperiod=self.buy_macd_1h_fast.value,
            slowperiod=self.buy_macd_1h_slow.value,
            signalperiod=self.buy_macd_1h_signal.value,
        )
        informative["macd"] = macd_1h["macd"]
        informative["macdsignal"] = macd_1h["macdsignal"]
        bb_1h = ta.BBANDS(
            informative,
        ...
        informative["bb_middle"] = bb_1h["middleband"]
